...
export default function Header() {
    ...
    return (
        <header className={`flex items-center justify-between fixed top-0 left-0 px-5 py-5 w-full z-20 gap-x-10 ${fullBlack ? 'bg-black' : 'bg-[rgba(0,0,0,.7)]'} h-[120px]`}>
            <span><Link to='/'><img src={`${process.env.PUBLIC_URL}/assets/images/logo.png`} className=" aspect-square rounded-full w-[80px]" alt="logo"/></Link></span>
