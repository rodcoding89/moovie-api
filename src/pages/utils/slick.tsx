    ...
    <div className={width+' carousel relative mx-auto'}>
      ...
      </Slider>
      {
        currentItem < data.length && (
          <span data-test-data={currentItem} onClick={next} className={providerStyle+right+' next absolute z-10 top-[50%] translate-y-[-50%] flex items-center justify-center text-[2.2em] cursor-pointer'}>
