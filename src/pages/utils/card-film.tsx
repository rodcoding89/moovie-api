...
export default function CardFilm({cardData}:{cardData:any}){
    return (
        <div className="relative h-[450px] flex items-center justify-center">
            ...
            <div className="flex items-center justify-center w-[70%] gap-x-8">
                <img src={process.env.PUBLIC_URL+'/'+cardData.linkImg1} alt={cardData.name} className="object-cover w-[200px] z-10" />
                <div className="z-10">
                    ...
                    <p className="text-left regular text-second-white text-[1em] mb-5">{cardData.description}</p>
