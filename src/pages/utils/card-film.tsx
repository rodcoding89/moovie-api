...
export default function CardFilm({cardData}:{cardData:any}){
    return (
        <div className="relative flex items-center justify-center">
            ...
            <div className="flex items-center justify-center w-[70%] gap-x-8 max-[707px]:flex-col max-[707px]:w-full">
                <img src={process.env.PUBLIC_URL+'/'+cardData.linkImg1} alt={cardData.name} className="object-cover w-[200px] z-10 max-[707px]:my-5" />
                <div className="z-10 max-[707px]:w-full max-[707px]:flex max-[707px]:items-center max-[707px]:justify-center max-[707px]:mx-5 max-[707px]:flex-col">
                    ...
                    <p className="text-left regular text-second-white text-[1em] mb-5 max-[707px]:mx-5">{cardData.description}</p>
