...
export default function CardFilm({cardData,link}:{cardData:any,link:string}){
    ...
    return (
        <div className="relative flex items-center justify-center h-[400px]">
            <img src={process.env.PUBLIC_URL+'/assets/images/the-acolyte.jpeg'} alt={cardData.name} className="absolute left-0 top-0 brightness-[.3] object-cover first-link h-full" />
